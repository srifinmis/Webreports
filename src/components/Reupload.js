...
//   };
//   const handleCicTypeChange = (e) => {
//         setCicType(e.target.value);
//       };
...
//     if (!csvFile || !cicType || !cutoffDate) {
//       alert('Please select a CSV file, CIC type, and cutoff date');
//       return;
//     }
...
//         const report = { cicType, cutoff_date: formattedCutoffDate };
...
//             <InputLabel>CIC Type</InputLabel>
//             <Select value={cicType} onChange={handleCicTypeChange} label="CIC Type">
...
//           Your report is ready! <a href={downloadLink} download>Click here to download the file</a>
//         </Typography>
//       )}
...
//           <ListItem key={index}>
//             <ListItemText primary={`CIC Type: ${report.cicType}`} secondary={`Cutoff Date: ${report.cutoff_date}`} />
//           </ListItem>
//         ))}
//       </List>
//     </Box>
